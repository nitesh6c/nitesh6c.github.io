...
import { getPaletteColorClasses } from './assignmentColorPalettes';
import { getCustomRoleColorPalette } from './customRoleColorPreferences';
import { isCustomRoleAssignmentCode } from './customRoles';
 ...
 */
export function getAssignmentColorClasses(
  assignmentCode: string,
  wcif?: Competition | null,
): AssignmentColorClasses {
  if (isCustomRoleAssignmentCode(assignmentCode)) {
    return getPaletteColorClasses(getCustomRoleColorPalette(assignmentCode));
  }
